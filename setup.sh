...
# ===============================================
#  🚀 SUPER-BOOTSTRAP DAORA KIDS LIVE (v2.8.27)
...
clear
echo -e "\033[1;32m🎨 INICIANDO DOMINAÇÃO HDMI v2.8.27\033[0m"
...
echo -e "\n\033[1;32m✅ SUCESSO v2.8.31!\033[0m"
