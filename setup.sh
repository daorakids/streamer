...
# ===============================================
#  🚀 SUPER-BOOTSTRAP DAORA KIDS LIVE (v2.9.6)
# ===============================================
...
clear
echo -e "\033[1;32m🎨 INICIANDO DOMINAÇÃO v2.9.6\033[0m"
...
echo -e "\n\033[1;32m✅ SUCESSO v2.9.6!\033[0m"
echo "🔄 Reiniciando..."
sync
sleep 5
reboot
