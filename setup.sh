...
# ===============================================
#  🚀 SUPER-BOOTSTRAP DAORA KIDS LIVE (v2.8.20)
...
clear
echo -e "\033[1;32m🎨 INICIANDO DOMINAÇÃO HDMI v2.8.20\033[0m"
...
echo -e "\n\033[1;32m✅ SUCESSO ABSOLUTO! v2.8.20\033[0m"
